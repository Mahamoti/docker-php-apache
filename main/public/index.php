...
<html lang="de">
<head>
    <title>elnebuloso/<?php echo getenv('ELNEBULOSO_CONTAINER_NAME'); ?>:<?php echo getenv('ELNEBULOSO_CONTAINER_VERSION'); ?></title>
</head>
<body>
...
<div class="center">
    ...
    <table>
        ...
        <tr class="h">
            <td>
                <h1 class="p">elnebuloso/<?php echo getenv('ELNEBULOSO_CONTAINER_NAME'); ?>:<?php echo getenv('ELNEBULOSO_CONTAINER_VERSION'); ?></h1>
            </td>
        </tr>
        </tbody>
    </table>
    ...
    <table>
        <tbody>
        <tr>
            <td class="e">ELNEBULOSO_CONTAINER_NAME</td>
            <td class="v"><?php echo getenv('ELNEBULOSO_CONTAINER_NAME'); ?></td>
        </tr>
        <tr>
            <td class="e">ELNEBULOSO_CONTAINER_VERSION</td>
            <td class="v"><?php echo getenv('ELNEBULOSO_CONTAINER_VERSION'); ?></td>
        </tr>
        <tr>
